...
适配工具在计算 LCD 各个顶点的坐标后会进行自动检查，以确保槽位配置的坐标合法（详见 [NTE 文档](https://www.zbx1425.cn/nautilus/mtr-nte/#/js-display-helper?id=%e6%98%be%e7%a4%ba%e5%b1%8f%e4%bd%8d%e7%bd%ae%e9%85%8d%e7%bd%ae)）。出现这个警告说明 LCD 的坐标可能不合法，这将导致 LCD 不显示。
